...
local color = readjson(gears.filesystem.get_cache_dir() .. "color/" .. user.color .. "/" .. user.color .. ".json")
...
theme.menu_bg_focus        = color.bgalt
theme.menu_fg_normal       = color.fg
theme.menu_fg_focus        = color.fg
theme.menu_border_color    = color.black
theme.menu_border_width    = dpi(1)

-- Wallpaper

color.wall = gears.filesystem.get_cache_dir() .. color.wall
